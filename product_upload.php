...
<?php
	...
	$sql = "INSERT INTO project.product(shopId,productName,productCategory,info,price,img1,img2,img3) VALUES(:s,:n,:c,:info,:p,:i1,:i2,:i3)";
	...
	myAlert("Product added in dataBase");
