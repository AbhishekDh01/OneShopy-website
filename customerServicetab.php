...
<?php
	$image="";
	$dir = 'uploads'; 
	$stmt = $conn->query("SELECT serName,serId,img1,img2,baseCharge FROM project.service;");
...
?>
	<div style=" background-image: url('<?php echo $image; ?>'); background-size: 100% 100%; background-repeat: no-repeat;"  class="product">
		...
		<form action='customerSeriveNavi.php' method='POST'
			...
			<input class="addstyle nonClick" style="margin-top: 216px;" type='submit' name='' value="Rs : <?php echo $row['baseCharge']; ?>" />
