...
if(isset($_POST['submit']) ){
	...
	$sql2 = "update project.customer_address set work_add ='".$n2."' where cid = $cid;";
	$sql1 = "update project.customer_address set pri_add ='".$_POST['Padd']."' where cid = $cid;";
	

	$sql3 = "update project.customer_address set home_add = '".$_POST['Hadd']."' where cid = $cid;";
	$sql4 = "update project.customer set name ='".$_POST['name']."' where cid = $cid;";
	$sql5 = "update project.customer set contactNo = '".$nou."' where cid = $cid;";
