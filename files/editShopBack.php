...
if(isset($_POST['submit']) ){
	...
	$sql1 = "update project.shop set shopName ='".$_POST['shopName']."' where shopId = $shopid;";
	
	$sql2 = "update project.shop set shopCategory ='".$_POST['shopCate']."' where shopId = $shopid;";

	$sql3 = "update project.shop set shopInfo = '".$_POST['shopInfo']."' where shopId = $shopid;";
	$sql4 = "update project.shop set shopAddress ='".$_POST['shopAdd']."' where shopId = $shopid;";
	$sql5 = "update project.shop set shopContact = '".$_POST['shopContact']."' where shopId = $shopid;";
