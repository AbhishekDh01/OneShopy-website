<?php
	...
	$stmt0 = $conn->query("SELECT shopCategory,shopName FROM project.shop where shopId = $shopid;");
...
<body>
  ...
  <div class="site-pusher">
	...
	<p>
	Add Images of Product (Max 3) <input type="file" name="files[]" multiple style="margin-top: 4px; margin-bottom: 4px; margin-left: 40px;">
	</p>
